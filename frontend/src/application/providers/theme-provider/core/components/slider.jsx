  ...
  styleOverrides: {
    root: ({ theme }) => ({
      [`& .${sliderClasses.thumb}`]: {
        ...
        borderColor: varAlpha(theme.palette.grey['500'], 0.08),
        '&::before': {
          opacity: 0.4,
          boxShadow: 'none',
          width: 'calc(100% - 4px)',
          ...
          backgroundImage: `linear-gradient(180deg, ${
            theme.palette.grey[500]
          }, ${varAlpha(theme.palette.grey['500'], 0)})`,
    ...
    markActive: ({ theme }) => ({
      backgroundColor: varAlpha(theme.palette.common.white, 0.64),
    }),
    markLabel: ({ theme }) => ({
    ...
    valueLabel: ({ theme }) => ({
      ...
      [stylesMode.dark]: { backgroundColor: theme.palette.grey[700] },
    }),
    sizeSmall: {
      [`& .${sliderClasses.thumb}`]: {
