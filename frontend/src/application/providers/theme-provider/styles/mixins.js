...
/**
 * Usage:
 * ...bgGradient({ color: `to right, ${theme.palette.grey[900]} 25%, ${alpha(theme.palette.primary.darker, 0.88)}`, imgUrl: '/assets/background/overlay.png' }),
 */
...
/**
 * Usage:
 * ...bgBlur({ color: `alpha(theme.palette.background.paper, 0.8)`, imgUrl: '/assets/background/overlay.png', blur: 6 }),
 */
...
/**
 * Usage:
 * ...paper({ theme, color: alpha(theme.palette.background.paper, 0.9), dropdown: true }),
 */
