...
import { usePathname } from '~/application/router/hooks';
import { isExternalLink } from '~/application/router/utils';
import { useActiveLink } from '~/application/router/hooks/use-active-link';

import { paper } from '~/application/providers/theme-provider/styles';
